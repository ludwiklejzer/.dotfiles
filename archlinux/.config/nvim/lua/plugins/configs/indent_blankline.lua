...
vim.g.indent_blankline_context_patterns = {	
	"abstract_class_declaration", "abstract_method_signature", "method",
	"accessibility_modifier", "ambient_declaration", "arguments", "array",
	"array_pattern", "array_type", "arrow_function", "as_expression",
	"asserts", "assignment_expression", "assignment_pattern", "^if",
	"augmented_assignment_expression", "await_expression", "^while",
	"binary_expression", "break_statement", "call_expression", "^for",
	"call_signature", "catch_clause", "class", "class_body", "^table",
	"class_declaration", "class_heritage", "computed_property_name",
	"conditional_type", "constraint", "construct_signature", "block",
	...
	"export_specifier", "export_statement", "expression", "arguments",
	"expression_statement", "extends_clause", "finally_clause",
	"flow_maybe_type", "for_in_statement", "for_statement", "^func",
